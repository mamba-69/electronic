...
const structure = {
  'backend': {
    ...
    'controllers': ['authController.js', 'productController.js', 'orderController.js', 'adminController.js', 'userController.js'],
  ...
  'frontend': {
    ...
    'src': {
      'components': {
        ...
        'products': ['ProductCard.jsx', 'ProductGrid.jsx', 'ProductDetails.jsx', 'ProductFilters.jsx'],
        'cart': ['CartItem.jsx', 'CartSummary.jsx', 'Checkout.jsx'],
        'admin': ['Dashboard.jsx', 'ProductForm.jsx', 'OrdersTable.jsx', 'Analytics.jsx']
      },
      'pages': {
        'admin': ['AdminDashboard.jsx', 'ProductManagement.jsx', 'OrderManagement.jsx'],
        'Home.jsx': '',
        'Shop.jsx': '',
        'ProductPage.jsx': '',
        'Cart.jsx': '',
